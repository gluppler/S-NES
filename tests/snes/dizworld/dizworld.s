; ============================================================================
; SNES Mode 7 Graphics Demo (Dizworld)
; ============================================================================
; Demonstrates 4 practical uses of Mode 7 affine transformation
;
; Controls:
...
;            D-pad to scroll, L/R to scale, Start to pause the spin
;   B      - Rotate around player (overhead level)
;            D-pad to rotate or move, L/R to scale
;   X      - Tilted view
;            L/R to adjust tilt, D-pad to move
;   Y      - Flying view (RPG world map, or racing game)
;            D-pad to rotate or move, L/R to raise/lower
;            Select to reset position (aspect ratio adjustment does not apply)
;
; Author: Brad Smith (rainwarrior)
; Website: https://rainwarrior.ca
; Source: https://github.com/rainwarrior/snes-stuff
; License: Creative Commons Attribution 4.0 (CC BY 4.0)
; See readme.md in this directory for full license and art credits
; ============================================================================
