...
cc65\bin\ca65 multest.asm -g --large-alignment -o multest.o  || @goto error

REM individual test source

cc65\bin\ca65 test_mul16.asm -g -o test_mul16.o  || @goto error
cc65\bin\ca65 test_div16.asm -g -o test_div16.o  || @goto error
