...
; ============================================================================
; Generic SNES controller test demonstrating auto-joypad reading
; Tests all 12 SNES buttons and displays controller state
;
; Author: Brad Smith (rainwarrior)
; Original NES version: 2020
; SNES adaptation: 2022
; Website: https://rainwarrior.ca
; Source: https://github.com/rainwarrior/snes-stuff
; License: See readme.txt in this directory
; ============================================================================
...
.exportzp c_sp = sp ; alias for C code compatibility
...
cc65_init:
	...
	sta sp+0
	sta c_sp+0 ; also set c_sp alias
	lda #>(cstack + CSTACK_SIZE)
	sta sp+1
	sta c_sp+1 ; also set c_sp alias
	rts
