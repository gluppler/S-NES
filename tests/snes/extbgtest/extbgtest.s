; ============================================================================
; SNES Mode 7 EXTBG Test
; ============================================================================
; Test of Mode 7 EXTBG (external background) feature
; Shows colors and layering of Mode 7 with EXTBG enabled
;
; The row marked 0 uses pixel values from 0-127
; The row marked 1 uses pixel values from 128-255
; The BG palettes for 128+ are darkened to show that BG1 is using them
; even with EXTBG enabled. The 4 movable sprites are on their numbered layer.
;
; Controls:
