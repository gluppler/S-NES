...
reset:
      ...
      lda   #123        
      jsr   delay_ya1
      lda   $5       ; at 29830 flag should be clear
      and   #$40
      bne   error
      ...
      lda   #123        
      jsr   delay_ya2
      lda   $5       ; at 29831 flag should be set
      and   #$40
      beq   error
      ...
      lda   #123        
      jsr   delay_ya3
      lda   $5       ; at 29832 read and clear flag
      lda   $5       ; flag should be set again
      and   #$40
      beq   error
      ...
      lda   #123        
      jsr   delay_ya4
      lda   $5       ; at 29833 read and clear flag
      lda   $5       ; flag should't be set again
      and   #$40
      bne   error
