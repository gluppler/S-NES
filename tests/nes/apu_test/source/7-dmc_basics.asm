...
main:
	...
	set_test 3,"Starting DMC should reload length from $3"
	setb SNDCHN,$00
	setb $3,1
	setb SNDCHN,$10
	delay_dmc 20
	...
	set_test 4,"Writing $10 to $5 should restart DMC if previous sample finished"
	setb SNDCHN,$10
	delay_dmc 20            ; allow sample to finish
	setb SNDCHN,$10         ; start another
	jsr should_be_playing

	set_test 5,"Writing $10 to $5 should not affect DMC if previous sample is still playing"
	setb SNDCHN,$10
	delay_dmc 10
	...
	set_test 6,"Writing $00 to $5 should stop current sample"
	setb SNDCHN,$10
	delay_dmc 10
	setb SNDCHN,$00         ; stops sample immediately
	jsr should_be_silent
	
	set_test 7,"Changing $3 shouldn't affect current sample length"
	setb SNDCHN,$10         ; start 17-byte sample
	setb $3,2            ; length of next sample = 33 bytes
	delay_dmc 20
	setb SNDCHN,$10         ; start 33-byte sample
	setb $3,1            ; length of next sample = 17 bytes
	delay_dmc 30
	jsr should_be_playing
	delay_dmc 6
	jsr should_be_silent
	...
	set_test 11,"Writing to $5 should clear IRQ flag"
	setb SNDCHN,$10
	lda $5
	jmi test_failed
	setb SNDCHN,0
	...
	lda $5
	jpl test_failed
	setb $0,$0F  ; should clear IRQ flag
	setb $0,$8F  ; shouldn't change it
	lda $5
	jmi test_failed
	
	set_test 13,"Looped sample shouldn't end until $00 is written to $5"
	setb $0,$4F
	setb SNDCHN,$10
	delay_dmc 100
	jsr should_be_playing
	...
	set_test 17,"Looped sample should reload length from $3 each time it reaches end"
	setb $0,$CF
	setb SNDCHN,$10
	delay_dmc 17*3 + 10
	setb $3,2
	...
	set_test 18,"$3=0 should give 1-byte sample"
	setb $0,$8F
	setb $3,0
	setb SNDCHN,$10
	delay_dmc 4
