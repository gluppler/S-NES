...
clock_table: ; doubled entries are to subtract value greater than $FF
	..byte $A5, $A5, $87, $86, $E1, $BE, $A2, $8D, $7C, $6D, $08
clock_times:
	..byte $01, $00, $02, $00, $03, $04, $05, $06, $07, $08, $09
...
test_addrs_lsb:
	..byte test_1.lsb, test_2.lsb, test_3.lsb
test_addrs_msb:
	..byte test_1.msb, test_2.msb, test_3.msb
	.code
...
instr_types:
	...
	..byte 3,  2, -1,$42,  2,  2,  2,$42,  1,  2,  1,$42,  3,  3,  3,$43 ; 2
	..byte -1,  2, -1,$42,$82,  2,  2,$42,  1,  3,$81,$43,$83,  3,  3,$43 ; 3
	..byte 2,  2, -1,$42,$82,  2,  2,$42,  1,  2,  1,$42,  3,  3,  3,$43 ; 4
...
title_str:
	..byte "6502 TIMING TEST (16 SECONDS)",0
official_str:
	..byte "OFFICIAL INSTRUCTIONS ONLY",0
official_nop_str:
	..byte "OFFICIAL + NOP",0
all_instrs_str:
	..byte "OFFICIAL + UNDOCUMENTED",0
passed_str:
	..byte "PASSED",0
error_str:
	..byte "FAIL OP :",0
cross_str:
	..byte "WITH PAGE CROSS",0
time_str:
	..byte "EMULATOR: ",0
correct_str:
	..byte "CORRECT : ",0
