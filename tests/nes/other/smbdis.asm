...
NonMaskableInterrupt:
               ...
               sta PPU_CTRL_REG1         ;(essentially $0) but save other bits
...
InitBuffer:    ldx VRAM_Buffer_Offset,y
               ...
               lda Mirror_PPU_CTRL_REG2  ;copy mirror of $1 to register
               sta PPU_CTRL_REG2
...
SkipSprite0:   lda HorizontalScroll      ;set scroll registers from variables
               ...
               lda VerticalScroll
               sta PPU_SCROLL_REG
               lda Mirror_PPU_CTRL_REG1  ;load saved mirror of $0
               pha
               sta PPU_CTRL_REG1
...
InitializeNameTables:
              ...
              lda Mirror_PPU_CTRL_REG1  ;load mirror of ppu reg $0
...
WriteBufferToScreen:
               ...
               pha
               lda Mirror_PPU_CTRL_REG1  ;load mirror of $0,
