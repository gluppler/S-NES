...
NES controllers use a **serial shift register** interface. Each controller has 8 buttons, represented as 8 bits that are shifted out one at a time.
...
- INSTRUCTIONS.md → 2️⃣ Advanced Fundamentals → 2.4 Controller I/O
