...
- [2.6 Advanced Optimization Techniques](../../advanced_fundamentals/2.6-optimization-techniques.md) - Detailed optimization guide
- [2.1 CPU Timing & Cycles](../../advanced_fundamentals/2.1-cpu-timing-cycles.md) - Cycle counting reference
