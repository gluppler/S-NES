...
| $0–$7 | 8 B | PPU Registers | Mirrored every 8 bytes |
| $2008–$3FFF | 7.992 KB | PPU Mirror | Mirrors $0–$7 |
| $0–$401F | 32 B | APU/I/O | APU, controllers, expansion |
...
## APU/I/O Registers ($0–$401F)

| Address | Name | R/W | Description |
|---------|------|-----|-------------|
| $0 | Pulse 1 Control | W | Duty, volume, envelope |
| $1 | Pulse 1 Sweep | W | Sweep unit |
| $2 | Pulse 1 Timer Low | W | Period low byte |
| $3 | Pulse 1 Timer High | W | Period high, length counter |
| $4 | Pulse 2 Control | W | Duty, volume, envelope |
| $5 | Pulse 2 Sweep | W | Sweep unit |
| $6 | Pulse 2 Timer Low | W | Period low byte |
| $7 | Pulse 2 Timer High | W | Period high, length counter |
| $8 | Triangle Control | W | Linear counter control |
| $9 | Triangle Unused | — | Unused |
| $A | Triangle Timer Low | W | Period low byte |
| $B | Triangle Timer High | W | Period high, length counter |
| $C | Noise Control | W | Volume, envelope |
| $D | Noise Unused | — | Unused |
| $E | Noise Period | W | Period, mode |
| $F | Noise Length | W | Length counter |
| $0 | DMC Control | W | IRQ, loop, period |
| $1 | DMC Value | W | Direct load |
| $2 | DMC Address | W | Sample address |
| $3 | DMC Length | W | Sample length |
| $4 | OAM DMA | W | OAM DMA high byte |
| $5 | APU Status | R/W | Channel enable, status |
| $6 | Controller 1 | R/W | Strobe (W), data (R) |
| $7 | Controller 2 / Frame Counter | R/W | Data (R), frame counter (W) |
...
- **PPU register mirroring: $0–$7 mirrored every 8 bytes to $3FFF
