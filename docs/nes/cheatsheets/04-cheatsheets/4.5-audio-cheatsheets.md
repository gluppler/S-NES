...
## APU Register Map ($0–$401F)

| Address | Channel | Register | Bits | Description |
|---------|---------|----------|------|-------------|
| $0 | Pulse 1 | Control | D D V V V V V V | Duty, volume, envelope |
| $1 | Pulse 1 | Sweep | E P P P S S S S | Enable, period, shift |
| $2 | Pulse 1 | Timer Low | T T T T T T T T | Period low byte |
| $3 | Pulse 1 | Timer High | L L L L L T T T | Length counter, period high |
| $4 | Pulse 2 | Control | D D V V V V V V | Duty, volume, envelope |
| $5 | Pulse 2 | Sweep | E P P P S S S S | Enable, period, shift |
| $6 | Pulse 2 | Timer Low | T T T T T T T T | Period low byte |
| $7 | Pulse 2 | Timer High | L L L L L T T T | Length counter, period high |
| $8 | Triangle | Control | C R R R R R R R | Linear counter control |
| $9 | Triangle | Unused | — | Unused |
| $A | Triangle | Timer Low | T T T T T T T T | Period low byte |
| $B | Triangle | Timer High | L L L L L T T T | Length counter, period high |
| $C | Noise | Control | L V V V V V V V | Loop, volume, envelope |
| $D | Noise | Unused | — | Unused |
| $E | Noise | Period | L P P P P P P P | Loop, period, mode |
| $F | Noise | Length | L L L L L L L L | Length counter |
| $0 | DMC | Control | I L P P P P P P | IRQ, loop, period |
| $1 | DMC | Value | D D D D D D D D | Direct load |
| $2 | DMC | Address | A A A A A A A A | Sample address (high) |
| $3 | DMC | Length | L L L L L L L L | Sample length (high) |
| $4 | OAM | DMA | A A A A A A A A | OAM DMA high byte |
| $5 | Status | Enable | I D N T P P P P | Channel enable, status |
| $6 | Controller 1 | I/O | D D D D D D D D | Strobe (W), data (R) |
| $7 | Controller 2 / Frame | I/O | M I D D D D D D | Data (R), frame counter (W) |

## Pulse Channel Control ($0, $4)
...
- **Frame counter: Must be initialized (write $7) to start timing
