...
reset:
    ...
    ; Indexed addressing
    LDY #$10
    LDA $0,Y  ; Load from $2010 (4-5 cycles, may cross page)
...
| PPU register reads | May return last write | Actual hardware state | Read $2 for real status |
