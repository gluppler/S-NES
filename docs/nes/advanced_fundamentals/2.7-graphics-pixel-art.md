...
- [1.4 PPU Fundamentals](../fundamentals/1.4-ppu-fundamentals.md) - Tiles, pattern tables, sprites
- [2.3 PPU Rendering Rules](2.3-ppu-rendering-rules.md) - VRAM access, VBlank
- [3.3 Rendering Architecture](../concepts/3.3-rendering-architecture.md) - OAM buffering, rendering pipeline
- [4.2 PPU Cheatsheets](../cheatsheets/04-cheatsheets/4.2-ppu-cheatsheets.md) - Register reference, sprite attributes
- [5.1 Sprite Engine Patterns](../techniques/05-applied-patterns/5.1-sprite-engine-patterns.md) - Sprite management
- [5.4 Animation Systems](../techniques/05-applied-patterns/5.4-animation-systems.md) - Animation techniques
