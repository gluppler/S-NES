...
* **VRAM: PPU memory (name tables $0–$2EFF, attribute tables)
...
4. **Scrolling** (Main Loop + NMI):
   - Update scroll registers ($5) based on camera position
...
* **Scrolling updates: Must update $5 every frame in NMI
